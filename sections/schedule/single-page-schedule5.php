...
remove_filter('posts_orderby','cr3ativoderby2');
    ...
    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1 schedule-time last">
        <p class="featured">4:45PM</p>
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 schedule-session" style="top: 0px;">
        <p class="featured-grey">Our after-party plans will be revealed!</p>
