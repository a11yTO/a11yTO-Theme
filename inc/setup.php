...
function a11yto_setup() {
	 ...
	 * If you're building a theme based on a11yto, use a find and replace
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'a11yto' ),
	) );
...
/*function new_excerpt_more( $more ) {
	return ' <p><a class="read-more btn btn-default" href="'. get_permalink( get_the_ID() ) . '">' . __('Read More', 'a11yto') . '</a></p>';
}
...
function all_excerpts_get_more_link($post_excerpt) {
    ...
    return $post_excerpt . ' [...]<p><a class="btn btn-secondary a11yto-read-more-link" href="'. get_permalink( get_the_ID() ) . '">' . __('Read More...', 'a11yto')  . '</a></p>';
}
