...
<div id="schedule-main" class="container">
...
remove_filter('posts_orderby','cr3ativoderby2');
        ...
        <?php } else { ?>
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 schedule camp">
            <div style="margin:15px;padding:15px;" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 red-border white schedule-single mWm-animated" data-animation="fade-in-from-bottom" data-delay="100">
        <?php $dateformat = get_option('date_format'); ?>
            ...
            <div class="session_content">
               ...
               <p> <a class="conference-more" href="<?php the_permalink (); ?>"><?php _e( 'more information +', 'cr3at_conf' ); ?></a></p>
            </div><!-- End of session content -->
