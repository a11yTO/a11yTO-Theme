...
<div id="page" class="hfeed site">
    ...
    <div class="wrapper-fluid wrapper-navbar" id="wrapper-navbar">
        ...
        <nav class="navbar navbar-dark bg-inverse red site-navigation" itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement">
    					...
    					&#9776;
                                 ...
                                 <!-- Your site title as branding in the menu -->
		                                ...
		                                <a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>"> <img src="<?php echo  get_template_directory_uri() . '/images/logo.png'?>" alt=""/>
		                                </a>
